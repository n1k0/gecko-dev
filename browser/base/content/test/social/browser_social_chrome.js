  ...
  let observer = {
    observe: function(aSubject, aTopic, aData) {
      if (aTopic === "sidebar-loaded") {
        ...
        obsSvc.removeObserver(observer, "sidebar-loaded");
        ...
        // Finish
        obsSvc.removeObserver(observer, "chat-loaded", false);
        finishcb();
      }
    }
  };

  obsSvc.addObserver(observer, "sidebar-loaded", false);
  obsSvc.addObserver(observer, "chat-loaded", false);
}
